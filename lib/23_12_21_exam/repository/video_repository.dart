...
class VideoRepository {
  List<YoutubeVideo> videos = [
    ...
    YoutubeVideo(
      videoId: 'BOqFRHCrN-k',
      uploadId: 'Disney Korea',
      title: '[엘리멘탈] 메인 예고편',
      viewCount: 2284752,
      uploadTime: DateTime(2023, 4, 5),
      kind: 'video',
      thumnail: 'https://img.youtube.com/vi/BOqFRHCrN-k/maxresdefault.jpg',
    ),
    YoutubeVideo(
      videoId: 'sRtVv44V4vI',
      uploadId: 'Disney Plus Korea 디즈니 플러스 코리아',
      title: '[로키] 메인 예고편 | 디즈니+',
      viewCount: 51876,
      uploadTime: DateTime(2021, 11, 10),
      kind: 'video',
      thumnail: 'https://img.youtube.com/vi/sRtVv44V4vI/maxresdefault.jpg',
    ),
    YoutubeVideo(
      videoId: 'bYCy1IdlTvU',
      uploadId: 'Disney Plus Korea 디즈니 플러스 코리아',
      ...
      uploadTime: DateTime(2023, 5, 9),
      kind: 'video',
      thumnail: 'https://img.youtube.com/vi/bYCy1IdlTvU/maxresdefault.jpg',
    ),
    YoutubeVideo(
      videoId: 'E3leN6mu9Ow',
      uploadId: '지우해',
